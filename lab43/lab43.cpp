...
//Created on: 11/0/2017
//Description: Lab 4.3 - Create an Online shop that keeps track of inventory, price
//                and the user's shopping cart. Create a class to hold the object name
//                price and current inventory. It should output all the object names for
//                the user to choose what they want. As user purchases it should remove
//                from inventory and add to customers total. When done it should add the
//                items to their cart and output that information of the purchase. Don't allow inventory to drop below 0.
