...
int main()
{
   ...
   person_per1 = ((( 60 / person_per1 ) * 60) * 24) * 365; //equation gives me how many people people in the US per year, (((x * 60sec)
   ...
   answer1 = (us_population + person_per1 + person_per2 + person_per3 - person_per4) * user_input1;
   ...
   the_year = the_year + user_input1;
    ...
    cout << "In the year "<< the_year <<"," << " the population will be " << us_population << " in the United States.";
